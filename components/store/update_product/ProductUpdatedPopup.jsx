...
export default function ProductUpdatedPopup({ formData, productUpdated, setProductUpdated }) {
        ...
        <div>
            <div>
                <div className='text-[18px] text-center my-2 text-gray-800'>
                    Hey, Product <span className="text-[24px] font-[400] px-[4px] text-[var(--main-bg)]">{`"${formData?.name}"`}</span> updated successfully...!
                    <br />
                </div>
