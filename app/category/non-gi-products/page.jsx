...
export default function ProductCategory() {
    ...
    useEffect(() => {
        document.title = `Non-GI products - Indian Heritage | Europe's first Indian GI tagged & organic store`;
    ...
    useEffect(() => {
        try {
            let temp = products.filter((item) => item.product_type?.slug === "non-gi-products");
